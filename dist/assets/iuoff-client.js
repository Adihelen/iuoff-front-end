...
define("iuoff-client/controllers/packages", ["exports", "ember"], function (exports, _ember) {
  exports["default"] = _ember["default"].Controller.extend({
    ...
    filteredPackages: _ember["default"].computed("title", "origin", function () {
...
if (!runningTests) {
  require("iuoff-client/app")["default"].create({"name":"iuoff-client","version":"0.0.0+f023f716"});
}
