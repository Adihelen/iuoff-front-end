  ...
  exports["default"] = _ember["default"].Controller.extend({
    ...
    filteredPackages: _ember["default"].computed("origin", "destination", "casal", "economy", "family", "confort", "friends", "xp", "travelStyle", "numDias", function () {
      ...
      if (origin) {
        ...
        var filteredStyles = [];
        filteredStyles = this.get('model').forEach(function (element) {
          element.get('styles').forEach(function (style) {
...
if (!runningTests) {
  require("iuoff-client/app")["default"].create({"name":"iuoff-client","version":"0.0.0+30ff0f0b"});
}
