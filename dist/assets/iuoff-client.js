    ...
    exports['default'] = _ember['default'].Controller.extend({
        ...
        actions: {
            tenhoInteresse: function tenhoInteresse() {
                ...
                var _solicitacao = this.createRecord('solicitacoes', {
