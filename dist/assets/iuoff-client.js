...
define("iuoff-client/controllers/packages", ["exports", "ember"], function (exports, _ember) {
  exports["default"] = _ember["default"].Controller.extend({
    ...
    queryParams: ["origin", "destination", "casal", "economy", "family", "confort", "friends", "xp", "travelStyle", "numDias", "title", "initialAmount"],
    ...
    filteredPackages: _ember["default"].computed("origin", "destination", "casal", "economy", "family", "confort", "friends", "xp", "travelStyle", "numDias", "title", "initialAmount", function () {
...
if (!runningTests) {
  require("iuoff-client/app")["default"].create({"name":"iuoff-client","version":"0.0.0+a194b34c"});
}
