...
define('iuoff-client/controllers/details', ['exports', 'ember'], function (exports, _ember) {
    ...
    exports['default'] = _ember['default'].Controller.extend({
        ...
        actions: {
            ...
            addAccomodation: function addAccomodation() {},
...
define('iuoff-client/models/solicitacoes', ['exports', 'ember-data'], function (exports, _emberData) {
    exports['default'] = _emberData['default'].Model.extend({
        // prenchidos em tela
        // dados do usuário
        ...
        //
        isDetalhes: _emberData['default'].attr('string'),
