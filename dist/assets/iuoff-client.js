...
define("iuoff-client/controllers/packages", ["exports", "ember"], function (exports, _ember) {
  exports["default"] = _ember["default"].Controller.extend({
    ...
    filteredPackages: _ember["default"].computed("model", "origin", "destination", function () {
...
define('iuoff-client/models/package', ['exports', 'ember-data', 'ember-data-model-fragments/attributes'], function (exports, _emberData, _emberDataModelFragmentsAttributes) {
  exports['default'] = _emberData['default'].Model.extend({
    ...
    styles: (0, _emberDataModelFragmentsAttributes.fragmentArray)('packages/styles'),
...
if (!runningTests) {
  require("iuoff-client/app")["default"].create({"name":"iuoff-client","version":"0.0.0+5311b7c1"});
}
