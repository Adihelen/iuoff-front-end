...
define("iuoff-client/controllers/packages", ["exports", "ember"], function (exports, _ember) {
  exports["default"] = _ember["default"].Controller.extend({
    ...
    filteredPackages: _ember["default"].computed("origin", "destination", "casal", "economy", "family", "confort", "friends", "xp", function () {
      var origin = this.get("origin");
      var destination = this.get("destination");
      var packages = this.get("model");

      // estilos de viagem
      var casal = this.get("casal");
      ...
      if (origin) {
        ...
        return packages.find(function (item) {
          item.styles.find(function (style) {
...
define('iuoff-client/models/package', ['exports', 'ember-data', 'ember-data-model-fragments/attributes'], function (exports, _emberData, _emberDataModelFragmentsAttributes) {
  exports['default'] = _emberData['default'].Model.extend({
    ...
    image: _emberData['default'].attr('string', { defaultValue: 'https://iuoff-admin.azurewebsites.net/assets/app/media/img/pacotes/iuoff-thumb.jpeg' })
...
if (!runningTests) {
  require("iuoff-client/app")["default"].create({"name":"iuoff-client","version":"0.0.0+463e7f1c"});
}
