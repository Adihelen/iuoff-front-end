...
define('iuoff-client/components/page-numbers', ['exports', 'ember-cli-pagination/components/page-numbers'], function (exports, _emberCliPaginationComponentsPageNumbers) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('iuoff-client/controllers/details', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    ...
    clearFieldsModal: function clearFieldsModal() {
      this.set('nome', '');
      this.set('email', '');
      this.set('tel', '');
      this.set('qtdPessoas', '');
...
define("iuoff-client/controllers/packages", ["exports", "ember", "ember-cli-pagination/computed/paged-array"], function (exports, _ember, _emberCliPaginationComputedPagedArray) {
  exports["default"] = _ember["default"].Controller.extend({

    store: _ember["default"].inject.service("store"),

    filteredContent: _ember["default"].computed.filterBy('content', 'isCompleted', false),

    filteredPackages: (0, _emberCliPaginationComputedPagedArray["default"])('content', function () {
      var packages = this.get('model');
      return packages;
    }),

    page: _ember["default"].computed.alias("filteredPackages.page"),
    perPage: _ember["default"].computed.alias("filteredPackages.perPage"),
    totalPages: _ember["default"].computed.oneWay("filteredPackages.totalPages"),
...
define('iuoff-client/initializers/allow-link-action', ['exports', 'ember-link-action/initializers/allow-link-action'], function (exports, _emberLinkActionInitializersAllowLinkAction) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('iuoff-client/mixins/link-action', ['exports', 'ember-link-action/mixins/link-action'], function (exports, _emberLinkActionMixinsLinkAction) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
if (!runningTests) {
  require("iuoff-client/app")["default"].create({"name":"iuoff-client","version":"0.0.0+28d3caf0"});
}
